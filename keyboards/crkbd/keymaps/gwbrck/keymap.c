...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x6_3(DE_DQUO, DE_CIRC, DE_DLR , DE_PIPE, DE_LBRC, DE_RBRC, KC_P7, KC_P8, KC_P9, DE_PERC, DE_SLSH , DE_EXLM, DE_QUOT, DE_AT, MT(MOD_LALT, DE_HASH), MT(MOD_LCTL, DE_TILD), MT(MOD_LGUI, DE_LPRN), DE_RPRN, KC_P4, MT(MOD_RGUI, KC_P5), MT(MOD_RCTL, KC_P6), MT(MOD_RALT, DE_PLUS), DE_MINS, DE_EQL, TG(2), DE_UNDS, DE_AMPR , DE_BSLS , DE_LCBR, DE_RCBR, KC_P1, KC_P2, KC_P3, KC_P0, DE_ASTR, TG(2), KC_TRNS, KC_HYPR, KC_SPC, KC_BSPC, KC_ENT, KC_TRNS),
